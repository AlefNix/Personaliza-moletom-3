...
//punho branca
  ...
  btncorvistaEazul.addEventListener('click', function(e){
    document.querySelectorAll(".botao").forEach(v => v.style.fill = "blue");
  ...
  btncorvistaEvermelha.addEventListener('click', function(e){
    document.querySelectorAll(".botao").forEach(v => v.style.fill = "red");
  ...
  btncorvistaEamarela.addEventListener('click', function(e){
    document.querySelectorAll(".botao").forEach(v => v.style.fill = "yellow");
  ...
  btncorpeitilho2azul.addEventListener('click', function(e){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = "blue");
  ...
  btncorpeitilho2vermelha.addEventListener('click', function(e){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = "red");
  ...
  btncorpeitilho2amarela.addEventListener('click', function(e){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = "yellow");
  ...
  btncorpeitilho2verde.addEventListener('click', function(e){
    document.querySelectorAll(".gola").forEach(v => v.style.fill = "green");
